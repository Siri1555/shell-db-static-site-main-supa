	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { 
						boxShadow: '0 0 5px rgba(0, 212, 255, 0.5), 0 0 25px rgba(0, 212, 255, 0.2)' 
					},
					'50%': { 
						boxShadow: '0 0 15px rgba(0, 212, 255, 0.8), 0 0 45px rgba(0, 212, 255, 0.4)' 
					}
				},
				'pulse-border': {
					'0%, 100%': { 
